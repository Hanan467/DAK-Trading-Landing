                    ...
                    <div className='card2 col-md-12 col-lg-1 mb-3 mb-lg-0'>
                        <div className='socials'>
                            <a href="" target="_blank" className='mt-5'>
                                <img className='card2-img' src={twitterLogo} alt="TwitterLogo" />
                            </a>
                            <a href="" target="_blank" className='mt-5'>
                                <img className='card2-img' src={linkedinLogo} alt="linkedinLogo" />
                            </a>
                            <a href="" target="_blank" className='mt-5'>
                                <img className='card2-img' src={facebookLogo} alt="FacebookLogo" />
                            </a>
                            <a href="" target="_blank" className='mt-5'>
                                <img className='card2-img' src={youtubeLogo} alt="youtubeLogo" />
                            </a>
                        </div>
                    </div>
